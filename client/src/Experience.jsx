...
function Experience() {
  ...
  return (
    <div className={isDark ? 'mesh-bg-dark' : 'mesh-bg-light'} style={{ minHeight: '100vh', fontFamily: "'Inter', sans-serif" }}>
      <style>{`
